...
def find_event_to_order(ls_symbols, d_data, order_file='HW6_Order.csv'):
    ...
    for s_symbol in ls_symbols:
        for i in range(20, len(ldt_timestamps)):
            ...
            if f_equity_boll_today < -2.0 and f_equity_boll_yest >= -2.0 and f_market_bool_today >= 1.1:
...
if __name__ == '__main__':
    ...
    ep.eventprofiler(df_events, d_data, i_lookback=20, i_lookforward=20,
                     s_filename='EventStudyHW06.pdf', b_market_neutral=True, b_errorbars=True,
                     s_market_sym='SPY')
